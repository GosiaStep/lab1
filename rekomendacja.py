...
print ("Nazywam si� Ma�gorzata St�pie�, m�j login GitHub to: GosiaStep, m�j temat pracy magisterskiej to: Ocena jako�ci danych przestrzennych OpenStreetMap")
print ("Moim zdaniem w powy�szym kodzie chodzi o to, �e u�ytkownicy ocenaj� danego wykonawc� i na podstawie tych ocen dobierani s� u�ytkownicy o podobnym gu�cie.")
